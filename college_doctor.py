...
w2 = Label(root, justify=LEFT,
           text="Diagnosis360", fg="white", bg="gray")
...
lrLb = Label(root, text="Decision Tree:", fg="white", bg="gray")
lrLb.grid(row=15, column=0, pady=10, sticky=W)

#destreeLb = Label(root, text="Random Forest:", fg="white", #bg="darkBlue")
#destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="Naive Bayes:", fg="white", bg="gray")
